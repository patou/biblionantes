  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            const Text("A propos", style: TextStyle(fontSize: 18),),
            ...
            const Text("Pour tous problèmes sur ou avec un document de la bibliothèque, vous devez contacter directement la bibliothèque.", style: TextStyle(fontSize: 14),),
            TextButton(onPressed: () async {
              await lauchUrl('https://bm.nantes.fr/home/contacts.html');
            },
              child: const Text("Contacter la bibliothèque de Nantes"),),
            const SizedBox(height: 10,),
            const Text("Le projet est opensource, vous pouvez retrouver tous le code ici :  ", style: TextStyle(fontSize: 14),),
            TextButton(onPressed: () async {
